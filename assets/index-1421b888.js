 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F4(t){I$(Zc),Ps(new _i("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return R4(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),Er(M_,F_,t),Er(M_,F_,"esm2017")}$n.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};$n.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};F4();const $4={apiKey:"AIzaSyDkWC69rklVP4x89l4iBxXBRgp9ClD9p40",authDomain:"test-582b2.firebaseapp.com",projectId:"test-582b2",storageBucket:"test-582b2.appspot.com",messagingSenderId:"925130837675",appId:"1:925130837675:web:d3470003dae1803bf931ee",databaseURL:"https://test-582b2-default-rtdb.europe-west1.firebasedatabase.app/"},xC=qE($4),Rg=n$(xC),j4=L4(xC);new Nn;const jl=Qc("auth/signUp",async({name:t,email:e,password:n},r)=>{try{const s=(await g$(Rg,e,n)).user;return await _$(s,{displayName:t}),{isAuthenticated:!0,email:s.email}}catch(i){return r.rejectWithValue(i.message)}}),Ul=Qc("auth/signIn",async({email:t,password:e},n)=>{try{const i=(await y$(Rg,t,e)).user;return{isAuthenticated:!0,name:i.displayName,email:i.email}}catch(r){return n.rejectWithValue(r.message)}}),zl=Qc("auth/logout",async(t,e)=>{try{await w$(Rg)}catch(n){return e.rejectWithValue(n.message)}});var CC={exports:{}},TC={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ba=T;function U4(t,e){return t===e&&(t!==0||1/t===1/e)||t!==t&&e!==e}var z4=typeof Object.is=="function"?Object.is:U4,B4=Ba.useSyncExternalStore,V4=Ba.useRef,W4=Ba.useEffect,H4=Ba.useMemo,G4=Ba.useDebugValue;TC.useSyncExternalStoreWithSelector=function(t,e,n,r,i){var s=V4(null);if(s.current===null){var o={hasValue:!1,value:null};s.current=o}else o=s.current;s=H4(function(){function l(m){if(!u){if(u=!0,c=m,m=r(m),i!==void 0&&o.hasValue){var g=o.value;if(i(g,m))return d=g}return d=m}if(g=d,z4(c,m))return g;var v=r(m);return i!==void 0&&i(g,v)?g:(c=m,d=v)}var u=!1,c,d,f=n===void 0?null:n;return[function(){return l(e())},f===null?void 0:function(){return l(f())}]},[e,n,r,i]);var a=B4(t,s[0],s[1]);return W4(function(){o.hasValue=!0,o.value=a},[a]),G4(a),a};CC.exports=TC;var K4=CC.exports,xt="default"in Ao?it:Ao,m0=Symbol.for("react-redux-context"),g0=typeof globalThis<"u"?globalThis:{};function q4(){if(!xt.createContext)return{};const t=g0[m0]??(g0[m0]=new Map);let e=t.get(xt.createContext);return e||(e=xt.createContext(null),t.set(xt.createContext,e)),e}var Nr=q4(),Y4=()=>{throw new Error("uSES not initialized!")};function Ng(t=Nr){return function(){return xt.useContext(t)}}var bC=Ng(),IC=Y4,Q4=t=>{IC=t},X4=(t,e)=>t===e;function J4(t=Nr){const e=t===Nr?bC:Ng(t),n=(r,i={})=>{const{equalityFn:s=X4,devModeChecks:o={}}=typeof i=="function"?{equalityFn:i}:i,{store:a,subscription:l,getServerState:u,stabilityCheck:c,identityFunctionCheck:d}=e();xt.useRef(!0);const f=xt.useCallback({[r.name](g){return r(g)}}[r.name],[r,c,o.stabilityCheck]),m=IC(l.addNestedSub,a.getState,u||a.getState,f,s);return xt.useDebugValue(m),m};return Object.assign(n,{withTypes:()=>n}),n}var As=J4();function Z4(t){t()}function e6(){let t=null,e=null;return{clear(){t=null,e=null},notify(){Z4(()=>{let n=t;for(;n;)n.callback(),n=n.next})},get(){const n=[];let r=t;for(;r;)n.push(r),r=r.next;return n},subscribe(n){let r=!0;const i=e={callback:n,next:null,prev:e};return i.prev?i.prev.next=i:t=i,function(){!r||t===null||(r=!1,i.next?i.next.prev=i.prev:e=i.prev,i.prev?i.prev.next=i.next:t=i.next)}}}}var y0={notify(){},get:()=>[]};function t6(t,e){let n,r=y0,i=0,s=!1;function o(v){c();const w=r.subscribe(v);let p=!1;return()=>{p||(p=!0,w(),d())}}function a(){r.notify()}function l(){g.onStateChange&&g.onStateChange()}function u(){return s}function c(){i++,n||(n=e?e.addNestedSub(l):t.subscribe(l),r=e6())}function d(){i--,n&&i===0&&(n(),n=void 0,r.clear(),r=y0)}function f(){s||(s=!0,c())}function m(){s&&(s=!1,d())}const g={addNestedSub:o,notifyNestedSubs:a,handleChangeWrapper:l,isSubscribed:u,trySubscribe:f,tryUnsubscribe:m,getListeners:()=>r};return g}var n6=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",r6=n6?xt.useLayoutEffect:xt.useEffect;function i6({store:t,context:e,children:n,serverState:r,stabilityCheck:i="once",identityFunctionCheck:s="once"}){const o=xt.useMemo(()=>{const u=t6(t);return{store:t,subscription:u,getServerState:r?()=>r:void 0,stabilityCheck:i,identityFunctionCheck:s}},[t,r,i,s]),a=xt.useMemo(()=>t.getState(),[t]);r6(()=>{const{subscription:u}=o;return u.onStateChange=u.notifyNestedSubs,u.trySubscribe(),a!==t.getState()&&u.notifyNestedSubs(),()=>{u.tryUnsubscribe(),u.onStateChange=void 0}},[o,a]);const l=e||Nr;return xt.createElement(l.Provider,{value:o},n)}var s6=i6;function kC(t=Nr){const e=t===Nr?bC:Ng(t),n=()=>{const{store:r}=e();return r};return Object.assign(n,{withTypes:()=>n}),n}var o6=kC();function a6(t=Nr){const e=t===Nr?o6:kC(t),n=()=>e().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var Va=a6();Q4(K4.useSyncExternalStoreWithSelector);function l6({onClose:t}){const e=Va(),n=km({userName:ls().min(2,"Name must be at least 2 characters long").max(16,"Name can be at most 16 characters long").matches(/^[a-zA-Z\s]+$/,"Name must contain only English letters and spaces").required("Name is required"),email:ls().email("Invalid email format").matches(/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/,"Invalid Email format").required("Email is required"),password:ls().min(6,"Password must be at least 6 characters long").max(16,"Password can be at most 16 characters long").matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])/,"Password must contain only English letters at least one digit, one lowercase letter, and one uppercase letter").required("Password is required")}),r=wE({initialValues:{userName:"",email:"",password:""},validationSchema:n,onSubmit:async i=>{console.log(i),e(jl(i))}});return _.jsxs(MO,{onSubmit:r.handleSubmit,children:[_.jsx(FO,{children:"Registration"}),_.jsx($O,{children:"Thank you for your interest in our platform! In order to register, we need some information. Please provide us with the following information"}),_.jsxs(Jd,{children:[_.jsx(ef,{id:"userName",name:"userName",type:"text",placeholder:"Name",onChange:r.handleChange,value:r.values.userName,className:`${r.touched.userName&&r.errors.userName?"is-invalid":""}`}),r.touched.userName&&r.errors.userName?_.jsx(_.Fragment,{children:_.jsx(Zd,{children:r.errors.userName})}):null]}),_.jsxs(Jd,{children:[_.jsx(ef,{id:"email",name:"email",type:"text",placeholder:"Email",onChange:r.handleChange,value:r.values.email,className:`${r.touched.email&&r.errors.email?"is-invalid":""}`}),r.touched.email&&r.errors.email?_.jsx(_.Fragment,{children:_.jsx(Zd,{children:r.errors.email})}):null]}),_.jsxs(Jd,{children:[_.jsx(ef,{id:"password",name:"password",type:r.values.showPassword?"text":"password",placeholder:"Password",onChange:r.handleChange,value:r.values.password,className:`${r.touched.password&&r.errors.password?"is-invalid":""}`}),_.jsx(jO,{type:"button",onClick:()=>{r.setFieldTouched("password",!1),r.setFieldValue("showPassword",!r.values.showPassword)},children:r.values.showPassword?_.jsx(Rv,{children:_.jsx("use",{href:_n+"#iconEyeOpen"})}):_.jsx(Rv,{children:_.jsx("use",{href:_n+"#iconEyeClosed"})})}),r.touched.password&&r.errors.password?_.jsx(Zd,{children:r.errors.password}):null]}),_.jsx(UO,{type:"submit",children:"Sign Up"}),_.jsx(zO,{onClick:()=>t(!1),children:_.jsx(BO,{children:_.jsx("use",{href:_n+"#icon-x"})})})]})}const u6=z.form`
  position: relative;
  margin: 0 auto;
  min-height: 420px;
...
`,S0=z.svg`
  ...
  width: 24px;
  height: 24px;
`;function g6({onClose:t}){const e=Va(),n=km({email:ls().email("Invalid email format").matches(/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/,"Invalid Email format").required("Email is required"),password:ls().min(6,"Password must be at least 6 characters long").max(16,"Password can be at most 16 characters long").matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])/,"Password must contain only English letters at least one digit, one lowercase letter, and one uppercase letter").required("Password is required")}),r=wE({initialValues:{email:"",password:""},validationSchema:n,onSubmit:async i=>{e(Ul(i))}});return _.jsxs(u6,{onSubmit:r.handleSubmit,children:[_.jsx(c6,{children:"Log In"}),_.jsx(d6,{children:"Welcome back! Please enter your credentials to access your account and continue your search for an teacher."}),_.jsxs(v0,{children:[_.jsx(w0,{id:"email",name:"email",type:"text",placeholder:"Email",onChange:r.handleChange,value:r.values.email,className:`${r.touched.email&&r.errors.email?"is-invalid":""}`}),r.touched.email&&r.errors.email?_.jsx(_.Fragment,{children:_.jsx(_0,{children:r.errors.email})}):null]}),_.jsxs(v0,{children:[_.jsx(w0,{id:"password",name:"password",type:r.values.showPassword?"text":"password",placeholder:"Password",onChange:r.handleChange,value:r.values.password,className:`${r.touched.password&&r.errors.password?"is-invalid":""}`}),_.jsx(f6,{type:"button",onClick:()=>{r.setFieldTouched("password",!1),r.setFieldValue("showPassword",!r.values.showPassword)},children:r.values.showPassword?_.jsx(S0,{children:_.jsx("use",{href:_n+"#iconEyeOpen"})}):_.jsx(S0,{children:_.jsx("use",{href:_n+"#iconEyeClosed"})})}),r.touched.password&&r.errors.password?_.jsx(_0,{children:r.errors.password}):null]}),_.jsx(h6,{type:"submit",children:"Log In"}),_.jsx(p6,{onClick:()=>t(!1),children:_.jsx(m6,{children:_.jsx("use",{href:_n+"#icon-x"})})})]})}function y6({color:t}){const[e,n]=T.useState(!1),[r,i]=T.useState(!1);return console.log(t),_.jsxs(_.Fragment,{children:[_.jsxs(UP,{children:[_.jsx(xv,{to:"/Home",children:"Home"}),_.jsx(xv,{to:"/Teachers",children:"Teachers"})]}),_.jsxs(zP,{children:[_.jsxs(BP,{onClick:()=>i(!r),children:[_.jsx(NS,{color:t,children:_.jsx("use",{href:_n+"#icon-log-in-01"})}),"Log in"]}),_.jsx(VP,{onClick:()=>n(!e),children:"Registration"})]}),e&&_.jsxs(Cv,{onClose:n,children:[" ",_.jsx(l6,{onClose:n})," "]}),r&&_.jsxs(Cv,{onClose:i,children:[" ",_.jsx(g6,{onClose:i})," "]})]})}const v6=z.nav`
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 0px 28px;
...
`,_6=z.button`
  ...
  font-weight: 700;
  line-height: 1.25;
`;function w6({color:t}){const e=Va();return _.jsxs(_.Fragment,{children:[_.jsxs(v6,{children:[_.jsx(Tf,{to:"/Home",children:"Home"}),_.jsx(Tf,{to:"/Teachers",children:"Teachers"}),_.jsx(Tf,{to:"/Favorites",children:"Favorites"})]}),_.jsxs(_6,{onClick:()=>e(zl()),children:[_.jsx(NS,{color:t,children:_.jsx("use",{href:_n+"#icon-log-in-01"})}),"Log out"]})]})}const Ag=t=>t.Auth.isAuth,S6=({color:t})=>{const e=As(Ag);return _.jsx(LP,{children:_.jsxs(MP,{children:[_.jsxs($P,{to:"/Home",children:[_.jsx(FP,{children:_.jsx("use",{href:_n+"#icon-ukraine"})}),_.jsx(jP,{children:"LearnLingo"})]}),e?_.jsx(w6,{color:t}):_.jsx(y6,{color:t})]})})};function dp(){return dp=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},dp.apply(this,arguments)}function E6(t){if(t.sheet)return t.sheet;for(var e=0;e<document.styleSheets.length;e++)if(document.styleSheets[e].ownerNode===t)return document.styleSheets[e]}function x6(t){var e=document.createElement("style");return e.setAttribute("data-emotion",t.key),t.nonce!==void 0&&e.setAttribute("nonce",t.nonce),e.appendChild(document.createTextNode("")),e.setAttribute("data-s",""),e}var C6=function(){function t(n){var r=this;this._insertTag=function(i){var s;r.tags.length===0?r.insertionPoint?s=r.insertionPoint.nextSibling:r.prepend?s=r.container.firstChild:s=r.before:s=r.tags[r.tags.length-1].nextSibling,r.container.insertBefore(i,s),r.tags.push(i)},this.isSpeedy=n.speedy===void 0?!0:n.speedy,this.tags=[],this.ctr=0,this.nonce=n.nonce,this.key=n.key,this.container=n.container,this.prepend=n.prepend,this.insertionPoint=n.insertionPoint,this.before=null}var e=t.prototype;return e.hydrate=function(r){r.forEach(this._insertTag)},e.insert=function(r){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(x6(this));var i=this.tags[this.tags.length-1];if(this.isSpeedy){var s=E6(i);try{s.insertRule(r,s.cssRules.length)}catch{}}else i.appendChild(document.createTextNode(r));this.ctr++},e.flush=function(){this.tags.forEach(function(r){return r.parentNode&&r.parentNode.removeChild(r)}),this.tags=[],this.ctr=0},t}(),Xe="-ms-",rc="-moz-",X="-webkit-",PC="comm",Dg="rule",Lg="decl",T6="@import",OC="@keyframes",b6="@layer",I6=Math.abs,ld=String.fromCharCode,k6=Object.assign;function P6(t,e){return Ve(t,0)^45?(((e<<2^Ve(t,0))<<2^Ve(t,1))<<2^Ve(t,2))<<2^Ve(t,3):0}function RC(t){return t.trim()}function O6(t,e){return(t=e.exec(t))?t[0]:t}function J(t,e,n){return t.replace(e,n)}function fp(t,e){return t.indexOf(e)}function Ve(t,e){return t.charCodeAt(e)|0}function va(t,e,n){return t.slice(e,n)}function pn(t){return t.length}function Mg(t){return t.length}function gl(t,e){return e.push(t),t}function R6(t,e){return t.map(e).join("")}var ud=1,Ds=1,NC=0,vt=0,be=0,Ks="";function cd(t,e,n,r,i,s,o){return{value:t,root:e,parent:n,type:r,props:i,children:s,line:ud,column:Ds,length:o,return:""}}function ao(t,e){return k6(cd("",null,null,"",null,null,0),t,{length:-t.length},e)}function N6(){return be}function A6(){return be=vt>0?Ve(Ks,--vt):0,Ds--,be===10&&(Ds=1,ud--),be}function kt(){return be=vt<NC?Ve(Ks,vt++):0,Ds++,be===10&&(Ds=1,ud++),be}function wn(){return Ve(Ks,vt)}function Bl(){return vt}function Wa(t,e){return va(Ks,t,e)}function _a(t){switch(t){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function AC(t){return ud=Ds=1,NC=pn(Ks=t),vt=0,[]}function DC(t){return Ks="",t}function Vl(t){return RC(Wa(vt-1,hp(t===91?t+2:t===40?t+1:t)))}function D6(t){for(;(be=wn())&&be<33;)kt();return _a(t)>2||_a(be)>3?"":" "}function L6(t,e){for(;--e&&kt()&&!(be<48||be>102||be>57&&be<65||be>70&&be<97););return Wa(t,Bl()+(e<6&&wn()==32&&kt()==32))}function hp(t){for(;kt();)switch(be){case t:return vt;case 34:case 39:t!==34&&t!==39&&hp(be);break;case 40:t===41&&hp(t);break;case 92:kt();break}return vt}function M6(t,e){for(;kt()&&t+be!==47+10;)if(t+be===42+42&&wn()===47)break;return"/*"+Wa(e,vt-1)+"*"+ld(t===47?t:kt())}function F6(t){for(;!_a(wn());)kt();return Wa(t,vt)}function $6(t){return DC(Wl("",null,null,null,[""],t=AC(t),0,[0],t))}function Wl(t,e,n,r,i,s,o,a,l){for(var u=0,c=0,d=o,f=0,m=0,g=0,v=1,w=1,p=1,h=0,y="",E=i,x=s,C=r,S=y;w;)switch(g=h,h=kt()){case 40:if(g!=108&&Ve(S,d-1)==58){fp(S+=J(Vl(h),"&","&\f"),"&\f")!=-1&&(p=-1);break}case 34:case 39:case 91:S+=Vl(h);break;case 9:case 10:case 13:case 32:S+=D6(g);break;case 92:S+=L6(Bl()-1,7);continue;case 47:switch(wn()){case 42:case 47:gl(j6(M6(kt(),Bl()),e,n),l);break;default:S+="/"}break;case 123*v:a[u++]=pn(S)*p;case 125*v:case 59:case 0:switch(h){case 0:case 125:w=0;case 59+c:p==-1&&(S=J(S,/\f/g,"")),m>0&&pn(S)-d&&gl(m>32?x0(S+";",r,n,d-1):x0(J(S," ","")+";",r,n,d-2),l);break;case 59:S+=";";default:if(gl(C=E0(S,e,n,u,c,i,a,y,E=[],x=[],d),s),h===123)if(c===0)Wl(S,e,C,C,E,s,d,a,x);else switch(f===99&&Ve(S,3)===110?100:f){case 100:case 108:case 109:case 115:Wl(t,C,C,r&&gl(E0(t,C,C,0,0,i,a,y,i,E=[],d),x),i,x,d,a,r?E:x);break;default:Wl(S,C,C,C,[""],x,0,a,x)}}u=c=m=0,v=p=1,y=S="",d=o;break;case 58:d=1+pn(S),m=g;default:if(v<1){if(h==123)--v;else if(h==125&&v++==0&&A6()==125)continue}switch(S+=ld(h),h*v){case 38:p=c>0?1:(S+="\f",-1);break;case 44:a[u++]=(pn(S)-1)*p,p=1;break;case 64:wn()===45&&(S+=Vl(kt())),f=wn(),c=d=pn(y=S+=F6(Bl())),h++;break;case 45:g===45&&pn(S)==2&&(v=0)}}return s}function E0(t,e,n,r,i,s,o,a,l,u,c){for(var d=i-1,f=i===0?s:[""],m=Mg(f),g=0,v=0,w=0;g<r;++g)for(var p=0,h=va(t,d+1,d=I6(v=o[g])),y=t;p<m;++p)(y=RC(v>0?f[p]+" "+h:J(h,/&\f/g,f[p])))&&(l[w++]=y);return cd(t,e,n,i===0?Dg:a,l,u,c)}function j6(t,e,n){return cd(t,e,n,PC,ld(N6()),va(t,2,-2),0)}function x0(t,e,n,r){return cd(t,e,n,Lg,va(t,0,r),va(t,r+1,-1),r)}function hs(t,e){for(var n="",r=Mg(t),i=0;i<r;i++)n+=e(t[i],i,t,e)||"";return n}function U6(t,e,n,r){switch(t.type){case b6:if(t.children.length)break;case T6:case Lg:return t.return=t.return||t.value;case PC:return"";case OC:return t.return=t.value+"{"+hs(t.children,r)+"}";case Dg:t.value=t.props.join(",")}return pn(n=hs(t.children,r))?t.return=t.value+"{"+n+"}":""}function z6(t){var e=Mg(t);return function(n,r,i,s){for(var o="",a=0;a<e;a++)o+=t[a](n,r,i,s)||"";return o}}function B6(t){return function(e){e.root||(e=e.return)&&t(e)}}var V6=function(e,n,r){for(var i=0,s=0;i=s,s=wn(),i===38&&s===12&&(n[r]=1),!_a(s);)kt();return Wa(e,vt)},W6=function(e,n){var r=-1,i=44;do switch(_a(i)){case 0:i===38&&wn()===12&&(n[r]=1),e[r]+=V6(vt-1,n,r);break;case 2:e[r]+=Vl(i);break;case 4:if(i===44){e[++r]=wn()===58?"&\f":"",n[r]=e[r].length;break}default:e[r]+=ld(i)}while(i=kt());return e},H6=function(e,n){return DC(W6(AC(e),n))},C0=new WeakMap,G6=function(e){if(!(e.type!=="rule"||!e.parent||e.length<1)){for(var n=e.value,r=e.parent,i=e.column===r.column&&e.line===r.line;r.type!=="rule";)if(r=r.parent,!r)return;if(!(e.props.length===1&&n.charCodeAt(0)!==58&&!C0.get(r))&&!i){C0.set(e,!0);for(var s=[],o=H6(n,s),a=r.props,l=0,u=0;l<o.length;l++)for(var c=0;c<a.length;c++,u++)e.props[u]=s[l]?o[l].replace(/&\f/g,a[c]):a[c]+" "+o[l]}}},K6=function(e){if(e.type==="decl"){var n=e.value;n.charCodeAt(0)===108&&n.charCodeAt(2)===98&&(e.return="",e.value="")}};function LC(t,e){switch(P6(t,e)){case 5103:return X+"print-"+t+t;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return X+t+t;case 5349:case 4246:case 4810:case 6968:case 2756:return X+t+rc+t+Xe+t+t;case 6828:case 4268:return X+t+Xe+t+t;case 6165:return X+t+Xe+"flex-"+t+t;case 5187:return X+t+J(t,/(\w+).+(:[^]+)/,X+"box-$1$2"+Xe+"flex-$1$2")+t;case 5443:return X+t+Xe+"flex-item-"+J(t,/flex-|-self/,"")+t;case 4675:return X+t+Xe+"flex-line-pack"+J(t,/align-content|flex-|-self/,"")+t;case 5548:return X+t+Xe+J(t,"shrink","negative")+t;case 5292:return X+t+Xe+J(t,"basis","preferred-size")+t;case 6060:return X+"box-"+J(t,"-grow","")+X+t+Xe+J(t,"grow","positive")+t;case 4554:return X+J(t,/([^-])(transform)/g,"$1"+X+"$2")+t;case 6187:return J(J(J(t,/(zoom-|grab)/,X+"$1"),/(image-set)/,X+"$1"),t,"")+t;case 5495:case 3959:return J(t,/(image-set\([^]*)/,X+"$1$`$1");case 4968:return J(J(t,/(.+:)(flex-)?(.*)/,X+"box-pack:$3"+Xe+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+X+t+t;case 4095:case 3583:case 4068:case 2532:return J(t,/(.+)-inline(.+)/,X+"$1$2")+t;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(pn(t)-1-e>6)switch(Ve(t,e+1)){case 109:if(Ve(t,e+4)!==45)break;case 102:return J(t,/(.+:)(.+)-([^]+)/,"$1"+X+"$2-$3$1"+rc+(Ve(t,e+3)==108?"$3":"$2-$3"))+t;case 115:return~fp(t,"stretch")?LC(J(t,"stretch","fill-available"),e)+t:t}break;case 4949:if(Ve(t,e+1)!==115)break;case 6444:switch(Ve(t,pn(t)-3-(~fp(t,"!important")&&10))){case 107:return J(t,":",":"+X)+t;case 101:return J(t,/(.+:)([^;!]+)(;|!.+)?/,"$1"+X+(Ve(t,14)===45?"inline-":"")+"box$3$1"+X+"$2$3$1"+Xe+"$2box$3")+t}break;case 5936:switch(Ve(t,e+11)){case 114:return X+t+Xe+J(t,/[svh]\w+-[tblr]{2}/,"tb")+t;case 108:return X+t+Xe+J(t,/[svh]\w+-[tblr]{2}/,"tb-rl")+t;case 45:return X+t+Xe+J(t,/[svh]\w+-[tblr]{2}/,"lr")+t}return X+t+Xe+t+t}return t}var q6=function(e,n,r,i){if(e.length>-1&&!e.return)switch(e.type){case Lg:e.return=LC(e.value,e.length);break;case OC:return hs([ao(e,{value:J(e.value,"@","@"+X)})],i);case Dg:if(e.length)return R6(e.props,function(s){switch(O6(s,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return hs([ao(e,{props:[J(s,/:(read-\w+)/,":"+rc+"$1")]})],i);case"::placeholder":return hs([ao(e,{props:[J(s,/:(plac\w+)/,":"+X+"input-$1")]}),ao(e,{props:[J(s,/:(plac\w+)/,":"+rc+"$1")]}),ao(e,{props:[J(s,/:(plac\w+)/,Xe+"input-$1")]})],i)}return""})}},Y6=[q6],Q6=function(e){var n=e.key;if(n==="css"){var r=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(r,function(v){var w=v.getAttribute("data-emotion");w.indexOf(" ")!==-1&&(document.head.appendChild(v),v.setAttribute("data-s",""))})}var i=e.stylisPlugins||Y6,s={},o,a=[];o=e.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+n+' "]'),function(v){for(var w=v.getAttribute("data-emotion").split(" "),p=1;p<w.length;p++)s[w[p]]=!0;a.push(v)});var l,u=[G6,K6];{var c,d=[U6,B6(function(v){c.insert(v)})],f=z6(u.concat(i,d)),m=function(w){return hs($6(w),f)};l=function(w,p,h,y){c=h,m(w?w+"{"+p.styles+"}":p.styles),y&&(g.inserted[p.name]=!0)}}var g={key:n,sheet:new C6({key:n,container:o,nonce:e.nonce,speedy:e.speedy,prepend:e.prepend,insertionPoint:e.insertionPoint}),nonce:e.nonce,inserted:s,registered:{},insert:l};return g.sheet.hydrate(a),g},X6=!0;function J6(t,e,n){var r="";return n.split(" ").forEach(function(i){t[i]!==void 0?e.push(t[i]+";"):r+=i+" "}),r}var MC=function(e,n,r){var i=e.key+"-"+n.name;(r===!1||X6===!1)&&e.registered[i]===void 0&&(e.registered[i]=n.styles)},Z6=function(e,n,r){MC(e,n,r);var i=e.key+"-"+n.name;if(e.inserted[n.name]===void 0){var s=n;do e.insert(n===s?"."+i:"",s,e.sheet,!0),s=s.next;while(s!==void 0)}};function eU(t){for(var e=0,n,r=0,i=t.length;i>=4;++r,i-=4)n=t.charCodeAt(r)&255|(t.charCodeAt(++r)&255)<<8|(t.charCodeAt(++r)&255)<<16|(t.charCodeAt(++r)&255)<<24,n=(n&65535)*1540483477+((n>>>16)*59797<<16),n^=n>>>24,e=(n&65535)*1540483477+((n>>>16)*59797<<16)^(e&65535)*1540483477+((e>>>16)*59797<<16);switch(i){case 3:e^=(t.charCodeAt(r+2)&255)<<16;case 2:e^=(t.charCodeAt(r+1)&255)<<8;case 1:e^=t.charCodeAt(r)&255,e=(e&65535)*1540483477+((e>>>16)*59797<<16)}return e^=e>>>13,e=(e&65535)*1540483477+((e>>>16)*59797<<16),((e^e>>>15)>>>0).toString(36)}var tU=/[A-Z]|^ms/g,nU=/_EMO_([^_]+?)_([^]*?)_EMO_/g,FC=function(e){return e.charCodeAt(1)===45},T0=function(e){return e!=null&&typeof e!="boolean"},bf=cS(function(t){return FC(t)?t:t.replace(tU,"-$&").toLowerCase()}),b0=function(e,n){switch(e){case"animation":case"animationName":if(typeof n=="string")return n.replace(nU,function(r,i,s){return mn={name:i,styles:s,next:mn},i})}return yS[e]!==1&&!FC(e)&&typeof n=="number"&&n!==0?n+"px":n};function wa(t,e,n){if(n==null)return"";if(n.__emotion_styles!==void 0)return n;switch(typeof n){case"boolean":return"";case"object":{if(n.anim===1)return mn={name:n.name,styles:n.styles,next:mn},n.name;if(n.styles!==void 0){var r=n.next;if(r!==void 0)for(;r!==void 0;)mn={name:r.name,styles:r.styles,next:mn},r=r.next;var i=n.styles+";";return i}return rU(t,e,n)}case"function":{if(t!==void 0){var s=mn,o=n(t);return mn=s,wa(t,e,o)}break}}if(e==null)return n;var a=e[n];return a!==void 0?a:n}function rU(t,e,n){var r="";if(Array.isArray(n))for(var i=0;i<n.length;i++)r+=wa(t,e,n[i])+";";else for(var s in n){var o=n[s];if(typeof o!="object")e!=null&&e[o]!==void 0?r+=s+"{"+e[o]+"}":T0(o)&&(r+=bf(s)+":"+b0(s,o)+";");else if(Array.isArray(o)&&typeof o[0]=="string"&&(e==null||e[o[0]]===void 0))for(var a=0;a<o.length;a++)T0(o[a])&&(r+=bf(s)+":"+b0(s,o[a])+";");else{var l=wa(t,e,o);switch(s){case"animation":case"animationName":{r+=bf(s)+":"+l+";";break}default:r+=s+"{"+l+"}"}}}return r}var I0=/label:\s*([^\s;\n{]+)\s*(;|$)/g,mn,iU=function(e,n,r){if(e.length===1&&typeof e[0]=="object"&&e[0]!==null&&e[0].styles!==void 0)return e[0];var i=!0,s="";mn=void 0;var o=e[0];o==null||o.raw===void 0?(i=!1,s+=wa(r,n,o)):s+=o[0];for(var a=1;a<e.length;a++)s+=wa(r,n,e[a]),i&&(s+=o[a]);I0.lastIndex=0;for(var l="",u;(u=I0.exec(s))!==null;)l+="-"+u[1];var c=eU(s)+l;return{name:c,styles:s,next:mn}},sU=function(e){return e()},oU=Ao["useInsertionEffect"]?Ao["useInsertionEffect"]:!1,aU=oU||sU,$C=T.createContext(typeof HTMLElement<"u"?Q6({key:"css"}):null);$C.Provider;var lU=function(e){return T.forwardRef(function(n,r){var i=T.useContext($C);return e(n,i,r)})},uU=T.createContext({}),cU=Nk,dU=function(e){return e!=="theme"},k0=function(e){return typeof e=="string"&&e.charCodeAt(0)>96?cU:dU},P0=function(e,n,r){var i;if(n){var s=n.shouldForwardProp;i=e.__emotion_forwardProp&&s?function(o){return e.__emotion_forwardProp(o)&&s(o)}:s}return typeof i!="function"&&r&&(i=e.__emotion_forwardProp),i},fU=function(e){var n=e.cache,r=e.serialized,i=e.isStringTag;return MC(n,r,i),aU(function(){return Z6(n,r,i)}),null},hU=function t(e,n){var r=e.__emotion_real===e,i=r&&e.__emotion_base||e,s,o;n!==void 0&&(s=n.label,o=n.target);var a=P0(e,n,r),l=a||k0(i),u=!l("as");return function(){var c=arguments,d=r&&e.__emotion_styles!==void 0?e.__emotion_styles.slice(0):[];if(s!==void 0&&d.push("label:"+s+";"),c[0]==null||c[0].raw===void 0)d.push.apply(d,c);else{d.push(c[0][0]);for(var f=c.length,m=1;m<f;m++)d.push(c[m],c[0][m])}var g=lU(function(v,w,p){var h=u&&v.as||i,y="",E=[],x=v;if(v.theme==null){x={};for(var C in v)x[C]=v[C];x.theme=T.useContext(uU)}typeof v.className=="string"?y=J6(w.registered,E,v.className):v.className!=null&&(y=v.className+" ");var S=iU(d.concat(E),w.registered,x);y+=w.key+"-"+S.name,o!==void 0&&(y+=" "+o);var P=u&&a===void 0?k0(h):l,j={};for(var L in v)u&&L==="as"||P(L)&&(j[L]=v[L]);return j.className=y,j.ref=p,T.createElement(T.Fragment,null,T.createElement(fU,{cache:w,serialized:S,isStringTag:typeof h=="string"}),T.createElement(h,j))});return g.displayName=s!==void 0?s:"Styled("+(typeof i=="string"?i:i.displayName||i.name||"Component")+")",g.defaultProps=e.defaultProps,g.__emotion_real=g,g.__emotion_base=i,g.__emotion_styles=d,g.__emotion_forwardProp=a,Object.defineProperty(g,"toString",{value:function(){return"."+o}}),g.withComponent=function(v,w){return t(v,dp({},n,w,{shouldForwardProp:P0(g,w,!0)})).apply(void 0,d)},g}},pU=["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"],D=hU.bind();pU.forEach(function(t){D[t]=D(t)});const mU=D.div`
  position: fixed;
  z-index: 1000;
  top: 0;
  left: 0;
...
`,gU=D.div`
  ...
  align-items: center;
  justify-content: center;
`,jC=({color:t})=>_.jsx(mU,{color:t,children:_.jsx(gU,{children:_.jsxs("div",{className:"lds-ripple",children:[_.jsx("div",{}),_.jsx("div",{})]})})}),yU=({color:t})=>_.jsxs(_.Fragment,{children:[_.jsx(S6,{color:t}),_.jsx(T.Suspense,{fallback:_.jsx(jC,{color:t}),children:_.jsx(gb,{})})]}),vU=D.div`
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 0px 24px;
...
`,TU="/Learn-Lingo/assets/ImgYelow-7772ad01.jpeg",bU="/Learn-Lingo/assets/imgGrean-b6010a5f.jpeg",IU="/Learn-Lingo/assets/imgLighPink-5fe905ec.jpeg",kU="/Learn-Lingo/assets/imgPink-98002fea.jpeg",PU="/Learn-Lingo/assets/imgBlue-e3826070.jpeg",OU=({color:t})=>(console.log(t),_.jsxs(_.Fragment,{children:[_.jsxs(vU,{children:[_.jsxs(SU,{children:[_.jsxs(_U,{children:["Unlock your potential with the best"," ",_.jsx(wU,{color:t,children:"language"})," tutors"]}),_.jsx(EU,{children:"Embark on an Exciting Language Journey with Expert Language Tutors: Elevate your language proficiency to new heights by connecting with highly qualified and experienced tutors."}),_.jsx(xU,{color:t,children:"Get started"})]}),t==="Blue"?_.jsx("img",{src:PU,alt:"girlImg",width:568,height:530}):null,t==="LightPink"?_.jsx("img",{src:IU,alt:"girlImg",width:568,height:530}):null,t==="Green"?_.jsx("img",{src:bU,alt:"girlImg",width:568,height:530}):null,t==="Orange"?_.jsx("img",{src:TU,alt:"girlImg",width:568,height:530}):null,t==="Pink"?_.jsx("img",{src:kU,alt:"girlImg",width:568,height:530}):null]}),_.jsx("footer",{children:_.jsxs(CU,{color:t,children:[_.jsxs(yl,{children:[_.jsx(vl,{children:"32,000 +"}),_.jsx(_l,{children:"Experienced tutors"})]}),_.jsxs(yl,{children:[_.jsx(vl,{children:"300,000 +"}),_.jsx(_l,{children:"5-star tutor reviews"})]}),_.jsxs(yl,{children:[_.jsx(vl,{children:"120 +"}),_.jsx(_l,{children:"Subjects taught"})]}),_.jsxs(yl,{children:[_.jsx(vl,{children:"200 +"}),_.jsx(_l,{children:"Tutor nationalities"})]})]})})]})),RU=D.ul`
  margin-top: 24px;
  align-items: center;
  display: flex;
...
`;var UC={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},O0=it.createContext&&it.createContext(UC),DU=["attr","size","title"];function LU(t,e){if(t==null)return{};var n=MU(t,e),r,i;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);for(i=0;i<s.length;i++)r=s[i],!(e.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(n[r]=t[r])}return n}function MU(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function ic(){return ic=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},ic.apply(this,arguments)}function R0(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function sc(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?R0(Object(n),!0).forEach(function(r){FU(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):R0(Object(n)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function FU(t,e,n){return e=$U(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function $U(t){var e=jU(t,"string");return typeof e=="symbol"?e:String(e)}function jU(t,e){if(typeof t!="object"||t===null)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var r=n.call(t,e||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function zC(t){return t&&t.map((e,n)=>it.createElement(e.tag,sc({key:n},e.attr),zC(e.child)))}function dd(t){return e=>it.createElement(UU,ic({attr:sc({},t.attr)},e),zC(t.child))}function UU(t){var e=n=>{var{attr:r,size:i,title:s}=t,o=LU(t,DU),a=i||n.size||"1em",l;return n.className&&(l=n.className),t.className&&(l=(l?l+" ":"")+t.className),it.createElement("svg",ic({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},n.attr,r,o,{className:l,style:sc(sc({color:t.color||n.color},n.style),t.style),height:a,width:a,xmlns:"http://www.w3.org/2000/svg"}),s&&it.createElement("title",null,s),t.children)};return O0!==void 0?it.createElement(O0.Consumer,null,n=>e(n)):e(UC)}function zU(t){return dd({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z",clipRule:"evenodd"},child:[]}]})(t)}function BU(t){return dd({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{d:"M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"},child:[]}]})(t)}function VU(t){return dd({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"},child:[]}]})(t)}function WU(t){return dd({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"},child:[]}]})(t)}const HU=D.li`
  position: relative;
  width: 100%;
  padding: 12px;
...
`,hz=D.p`
  ...
  font-weight: 500;
  line-height: 1.5;
`,Hl=Qc("teachers/getAllTeachers",async(t,e)=>{const n=b4(j4);try{const r=await I4(nc(n,"/"));if(r.exists()){const i=r.val();return Object.values(i)}}catch(r){return e.rejectWithValue(r.message)}}),pz={teachers:[],teachersFavorites:[],isLoading:!1},BC=LE({name:"teachers",initialState:pz,extraReducers:t=>{t.addCase(Hl.pending,e=>{e.isLoading=!0}).addCase(Hl.fulfilled,(e,{payload:n})=>{e.isLoading=!1,e.teachers=n}).addCase(Hl.rejected,e=>{e.isLoading=!1})},reducers:{addFavorites(t,e){t.teachersFavorites.push(e.payload)},deleteFavorites(t,e){const n=t.teachersFavorites.filter(r=>r.avatar_url!==e.payload.avatar_url);t.teachersFavorites=n}}}),{addFavorites:mz,deleteFavorites:gz}=BC.actions,yz=BC.reducer,vz=t=>t.teachers.teachers,_z=t=>t.teachers.isLoading,wz=t=>t.teachers.teachersFavorites,Sz=({teacher:t,levelFilter:e,color:n})=>{const{name:r,surname:i,languages:s,levels:o,rating:a,reviews:l,price_per_hour:u,lessons_done:c,avatar_url:d,lesson_info:f,conditions:m,experience:g}=t,v=Va(),[w,p]=T.useState(!1),h=As(wz),y=As(Ag),[E,x]=T.useState(!1);T.useEffect(()=>{h.find(P=>P.avatar_url===d)!==void 0&&x(!0)},[d,h]);const C=()=>{x(!E),v(E?gz(t):mz(t))};return _.jsxs(HU,{children:[_.jsx(GU,{color:n,children:_.jsx(KU,{src:d,height:"100px",width:"100px"})}),_.jsxs(qU,{children:[_.jsxs(YU,{children:[_.jsxs(nz,{children:[_.jsx("p",{children:"Languages"}),_.jsxs(rz,{children:[r," ",i]})]}),_.jsxs("ul",{children:[_.jsxs("li",{children:[_.jsx(tz,{size:"16px"})," Lessons online"]}),_.jsxs("li",{children:["Lessons done: ",c]}),_.jsxs("li",{children:[_.jsx(N0,{})," Rating: ",a]}),_.jsxs("li",{children:["Price / 1 hour: ",_.jsxs("span",{children:[u," $"]})]})]}),y&&_.jsx(ZU,{type:"button",onClick:C,children:E?_.jsx(ez,{size:26}):_.jsx(JU,{size:26})})]}),_.jsxs(iz,{children:["Speaks: ",_.jsx("span",{children:s==null?void 0:s.join(", ")})]}),_.jsxs(A0,{children:["Lesson Info:",_.jsx("span",{children:f})]}),_.jsxs(A0,{children:["Conditions:",_.jsx("span",{children:m})]}),!w&&_.jsx(D0,{onClick:()=>p(!0),children:"Read more"}),w&&_.jsxs(_.Fragment,{children:[_.jsx(sz,{children:g}),_.jsx(oz,{children:l.map((S,P)=>_.jsxs(az,{children:[_.jsxs(lz,{children:[_.jsx(uz,{children:_.jsx(cz,{children:S.reviewer_name.charAt(0).toUpperCase()})}),_.jsxs(dz,{children:[_.jsx(fz,{children:S.reviewer_name}),_.jsxs("span",{children:[_.jsx(N0,{}),S.reviewer_rating,".0"]})]})]}),_.jsx(hz,{children:S.comment})]},P))}),w&&_.jsx(D0,{onClick:()=>p(!1),children:"Read less"})]}),_.jsx(QU,{children:o.map((S,P)=>_.jsx(XU,{className:S===e?"selected":"",children:S},P))})]})]})};let Ez=(t=21)=>crypto.getRandomValues(new Uint8Array(t)).reduce((e,n)=>(n&=63,n<36?e+=n.toString(36):n<62?e+=(n-26).toString(36).toUpperCase():n>62?e+="-":e+="_",e),"");const xz=z.div`
  position: relative;
  display: inline-block;
`,Cz=z.div`
  display: flex;
...
`;function If({arr:t,value:e,set:n,height:r,selectedOption:i}){const[s,o]=T.useState(!1),a=()=>{o(!s)},l=c=>{n(c),o(!1)},u=T.useRef(null);return T.useEffect(()=>{const c=d=>{u.current&&!u.current.contains(d.target)&&o(!1)};return document.addEventListener("click",c),()=>{document.removeEventListener("click",c)}},[u]),_.jsxs(xz,{children:[_.jsxs(Cz,{onClick:a,ref:u,children:[_.jsx(Tz,{children:i||e}),_.jsx(kz,{$active:s?!0:void 0,children:_.jsx("use",{href:_n+"#icon-chevron-down"})})]}),s&&_.jsx(bz,{$heigh:r||void 0,children:t.map((c,d)=>_.jsx(Iz,{onClick:()=>l(c),children:c},d))})]})}const Pz=z.ul`
  display: flex;
  justify-content: center;
...
`;function Oz(){const[t,e]=T.useState(""),[n,r]=T.useState(""),[i,s]=T.useState(""),o=["French","English","German","Ukrainian","Polish"],a=["A1 Beginner","A2 Elementary","B1 Intermediate","B2 Upper-Intermediate"];let l=[10,20,30,40];return _.jsx(_.Fragment,{children:_.jsxs(Pz,{children:[_.jsxs("li",{children:[_.jsx("span",{children:"Languages"}),_.jsx(If,{arr:o,value:"Enter the text",set:e,selectedOption:t})]}),_.jsxs("li",{children:[_.jsx("span",{children:"Level of knowledge"}),_.jsx(If,{arr:a,value:"To $",set:s,height:!0,selectedOption:i})]}),_.jsxs("li",{children:[_.jsx("span",{children:"Price"}),_.jsx(If,{arr:l,value:"To $",set:r,height:!0,selectedOption:n})]})]})})}function Rz({color:t}){const e=As(vz),n=As(_z),[r,i]=T.useState(4),s=()=>{i(a=>a+4)},o=e==null?void 0:e.slice(0,r);return _.jsx(_.Fragment,{children:n?_.jsx(jC,{color:t}):_.jsxs(AU,{children:[_.jsx(Oz,{}),_.jsx(RU,{children:o&&(o==null?void 0:o.map(a=>_.jsx(Sz,{color:t,teacher:a},Ez())))}),(e==null?void 0:e.length)>r&&_.jsx(NU,{color:t,onClick:s,children:"Load more"})]})})}const Nz=({color:t})=>_.jsx(Rz,{color:t}),Az=D.div`
  display: flex;
  justify-content: center;
  align-items: center;
  padding-top: 500px;
...
`;const Mz=()=>_.jsx(Az,{children:_.jsx(Dz,{children:_.jsx(Lz,{children:"favorites Page"})})}),Fz=D.div`
  display: flex;
  justify-content: center;
  align-items: center;
  padding-top: 500px;
`,$z=D.h1`
  color: #ffffff;
`,jz=()=>_.jsx(Fz,{children:_.jsx($z,{children:"404"})}),Uz=D.div`
  width: 100%;
  height: 100vh;
  background-size: 100% 100%;
`;function zz({component:t,redirectTo:e}){return As(Ag)?t:_.jsx(sw,{to:e})}function Bz(){const[t,e]=T.useState(null),n=Va(),r={Blue:"Blue",LightPink:"LightPink",Green:"Green",Orange:"Orange",Pink:"Pink"};return T.useEffect(()=>{n(Hl())},[n]),T.useEffect(()=>{e(Object.keys(r)[Math.floor(Math.random()*Object.keys(r).length)])},[]),_.jsx(Uz,{children:_.jsx(vb,{children:_.jsxs(Vr,{path:"/",element:_.jsx(yU,{color:t}),children:[_.jsx(Vr,{index:!0,element:_.jsx(sw,{to:"Home"})}),_.jsx(Vr,{path:"/Home",element:_.jsx(OU,{color:t})}),_.jsx(Vr,{path:"/Teachers",element:_.jsx(Nz,{color:t})}),_.jsx(Vr,{path:"/Favorites",element:_.jsx(zz,{redirectTo:"/",component:_.jsx(Mz,{})})}),_.jsx(Vr,{path:"*",element:_.jsx(jz,{})})]})})})}const Vz={name:"",email:"",isAuth:!1,error:null,loading:!1},Wz=LE({name:"auth",initialState:Vz,extraReducers:t=>{t.addCase(jl.pending,e=>{e.error=null,e.loading=!0}).addCase(jl.fulfilled,(e,{payload:n})=>{const{email:r,userName:i}=n;e.name=i||"",e.email=r,e.error=null,e.loading=!1,e.isAuth=!0}).addCase(jl.rejected,(e,{payload:n})=>{e.error=n,e.loading=!1,e.isAuth=!1}).addCase(Ul.pending,e=>{e.error=null,e.loading=!0}).addCase(Ul.fulfilled,(e,{payload:n})=>{const{email:r,name:i}=n;e.name=i,e.email=r,e.error=null,e.loading=!1,e.isAuth=!0}).addCase(Ul.rejected,(e,{payload:n})=>{e.error=n,e.loading=!1,e.isAuth=!1}).addCase(zl.pending,e=>{e.error=null,e.loading=!0}).addCase(zl.fulfilled,e=>{e.name="",e.email="",e.error=null,e.loading=!1,e.isAuth=!1}).addCase(zl.rejected,(e,{payload:n})=>{e.error=n,e.loading=!1,e.isAuth=!1,e.name="",e.email=""})}}),Hz=Wz.reducer;var Fg="persist:",$g="persist/FLUSH",fd="persist/REHYDRATE",jg="persist/PAUSE",Ug="persist/PERSIST",zg="persist/PURGE",Bg="persist/REGISTER",Gz=-1;function Gl(t){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Gl=function(n){return typeof n}:Gl=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Gl(t)}function L0(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function Kz(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?L0(n,!0).forEach(function(r){qz(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):L0(n).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function qz(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function Yz(t,e,n,r){r.debug;var i=Kz({},n);return t&&Gl(t)==="object"&&Object.keys(t).forEach(function(s){s!=="_persist"&&e[s]===n[s]&&(i[s]=t[s])}),i}function Qz(t){var e=t.blacklist||null,n=t.whitelist||null,r=t.transforms||[],i=t.throttle||0,s="".concat(t.keyPrefix!==void 0?t.keyPrefix:Fg).concat(t.key),o=t.storage,a;t.serialize===!1?a=function(x){return x}:typeof t.serialize=="function"?a=t.serialize:a=Xz;var l=t.writeFailHandler||null,u={},c={},d=[],f=null,m=null,g=function(x){Object.keys(x).forEach(function(C){p(C)&&u[C]!==x[C]&&d.indexOf(C)===-1&&d.push(C)}),Object.keys(u).forEach(function(C){x[C]===void 0&&p(C)&&d.indexOf(C)===-1&&u[C]!==void 0&&d.push(C)}),f===null&&(f=setInterval(v,i)),u=x};function v(){if(d.length===0){f&&clearInterval(f),f=null;return}var E=d.shift(),x=r.reduce(function(C,S){return S.in(C,E,u)},u[E]);if(x!==void 0)try{c[E]=a(x)}catch(C){console.error("redux-persist/createPersistoid: error serializing state",C)}else delete c[E];d.length===0&&w()}function w(){Object.keys(c).forEach(function(E){u[E]===void 0&&delete c[E]}),m=o.setItem(s,a(c)).catch(h)}function p(E){return!(n&&n.indexOf(E)===-1&&E!=="_persist"||e&&e.indexOf(E)!==-1)}function h(E){l&&l(E)}var y=function(){for(;d.length!==0;)v();return m||Promise.resolve()};return{update:g,flush:y}}function Xz(t){return JSON.stringify(t)}function Jz(t){var e=t.transforms||[],n="".concat(t.keyPrefix!==void 0?t.keyPrefix:Fg).concat(t.key),r=t.storage;t.debug;var i;return t.deserialize===!1?i=function(o){return o}:typeof t.deserialize=="function"?i=t.deserialize:i=Zz,r.getItem(n).then(function(s){if(s)try{var o={},a=i(s);return Object.keys(a).forEach(function(l){o[l]=e.reduceRight(function(u,c){return c.out(u,l,a)},i(a[l]))}),o}catch(l){throw l}else return})}function Zz(t){return JSON.parse(t)}function e5(t){var e=t.storage,n="".concat(t.keyPrefix!==void 0?t.keyPrefix:Fg).concat(t.key);return e.removeItem(n,t5)}function t5(t){}function M0(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function kn(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?M0(n,!0).forEach(function(r){n5(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):M0(n).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function n5(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function r5(t,e){if(t==null)return{};var n=i5(t,e),r,i;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);for(i=0;i<s.length;i++)r=s[i],!(e.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(n[r]=t[r])}return n}function i5(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}var s5=5e3;function o5(t,e){var n=t.version!==void 0?t.version:Gz;t.debug;var r=t.stateReconciler===void 0?Yz:t.stateReconciler,i=t.getStoredState||Jz,s=t.timeout!==void 0?t.timeout:s5,o=null,a=!1,l=!0,u=function(d){return d._persist.rehydrated&&o&&!l&&o.update(d),d};return function(c,d){var f=c||{},m=f._persist,g=r5(f,["_persist"]),v=g;if(d.type===Ug){var w=!1,p=function(P,j){w||(d.rehydrate(t.key,P,j),w=!0)};if(s&&setTimeout(function(){!w&&p(void 0,new Error('redux-persist: persist timed out for persist key "'.concat(t.key,'"')))},s),l=!1,o||(o=Qz(t)),m)return kn({},e(v,d),{_persist:m});if(typeof d.rehydrate!="function"||typeof d.register!="function")throw new Error("redux-persist: either rehydrate or register is not a function on the PERSIST action. This can happen if the action is being replayed. This is an unexplored use case, please open an issue and we will figure out a resolution.");return d.register(t.key),i(t).then(function(S){var P=t.migrate||function(j,L){return Promise.resolve(j)};P(S,n).then(function(j){p(j)},function(j){p(void 0,j)})},function(S){p(void 0,S)}),kn({},e(v,d),{_persist:{version:n,rehydrated:!1}})}else{if(d.type===zg)return a=!0,d.result(e5(t)),kn({},e(v,d),{_persist:m});if(d.type===$g)return d.result(o&&o.flush()),kn({},e(v,d),{_persist:m});if(d.type===jg)l=!0;else if(d.type===fd){if(a)return kn({},v,{_persist:kn({},m,{rehydrated:!0})});if(d.key===t.key){var h=e(v,d),y=d.payload,E=r!==!1&&y!==void 0?r(y,c,h,t):h,x=kn({},E,{_persist:kn({},m,{rehydrated:!0})});return u(x)}}}if(!m)return e(c,d);var C=e(v,d);return C===v?c:u(kn({},C,{_persist:m}))}}var Vg={},Wg={};Wg.__esModule=!0;Wg.default=u5;function Kl(t){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Kl=function(n){return typeof n}:Kl=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Kl(t)}function kf(){}var a5={getItem:kf,setItem:kf,removeItem:kf};function l5(t){if((typeof self>"u"?"undefined":Kl(self))!=="object"||!(t in self))return!1;try{var e=self[t],n="redux-persist ".concat(t," test");e.setItem(n,"test"),e.getItem(n),e.removeItem(n)}catch{return!1}return!0}function u5(t){var e="".concat(t,"Storage");return l5(e)?self[e]:a5}Vg.__esModule=!0;Vg.default=f5;var c5=d5(Wg);function d5(t){return t&&t.__esModule?t:{default:t}}function f5(t){var e=(0,c5.default)(t);return{getItem:function(r){return new Promise(function(i,s){i(e.getItem(r))})},setItem:function(r,i){return new Promise(function(s,o){s(e.setItem(r,i))})},removeItem:function(r){return new Promise(function(i,s){i(e.removeItem(r))})}}}var VC=void 0,h5=p5(Vg);function p5(t){return t&&t.__esModule?t:{default:t}}var m5=(0,h5.default)("local");VC=m5;function F0(t){return v5(t)||y5(t)||g5()}function g5(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function y5(t){if(Symbol.iterator in Object(t)||Object.prototype.toString.call(t)==="[object Arguments]")return Array.from(t)}function v5(t){if(Array.isArray(t)){for(var e=0,n=new Array(t.length);e<t.length;e++)n[e]=t[e];return n}}function $0(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function pp(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?$0(n,!0).forEach(function(r){_5(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):$0(n).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function _5(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var WC={registry:[],bootstrapped:!1},w5=function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:WC,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case Bg:return pp({},e,{registry:[].concat(F0(e.registry),[n.key])});case fd:var r=e.registry.indexOf(n.key),i=F0(e.registry);return i.splice(r,1),pp({},e,{registry:i,bootstrapped:i.length===0});default:return e}};function S5(t,e,n){var r=n||!1,i=Vm(w5,WC,e&&e.enhancer?e.enhancer:void 0),s=function(u){i.dispatch({type:Bg,key:u})},o=function(u,c,d){var f={type:fd,payload:c,err:d,key:u};t.dispatch(f),i.dispatch(f),r&&a.getState().bootstrapped&&(r(),r=!1)},a=pp({},i,{purge:function(){var u=[];return t.dispatch({type:zg,result:function(d){u.push(d)}}),Promise.all(u)},flush:function(){var u=[];return t.dispatch({type:$g,result:function(d){u.push(d)}}),Promise.all(u)},pause:function(){t.dispatch({type:jg})},persist:function(){t.dispatch({type:Ug,register:s,rehydrate:o})}});return e&&e.manualPersist||a.persist(),a}const E5=SE({teachers:yz,Auth:Hz}),x5={key:"teachers",storage:VC,whitelist:["teachersFavorites","Auth"]},C5=o5(x5,E5),HC=yL({reducer:C5,middleware:t=>t({serializableCheck:{ignoredActions:[$g,fd,jg,Ug,zg,Bg]}})}),T5=S5(HC);function ql(t){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?ql=function(n){return typeof n}:ql=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},ql(t)}function b5(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function j0(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}function I5(t,e,n){return e&&j0(t.prototype,e),n&&j0(t,n),t}function k5(t,e){return e&&(ql(e)==="object"||typeof e=="function")?e:Yl(t)}function mp(t){return mp=Object.setPrototypeOf?Object.getPrototypeOf:function(n){return n.__proto__||Object.getPrototypeOf(n)},mp(t)}function Yl(t){if(t===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}function P5(t,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&&gp(t,e)}function gp(t,e){return gp=Object.setPrototypeOf||function(r,i){return r.__proto__=i,r},gp(t,e)}function Ql(t,e,n){return e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}var GC=function(t){P5(e,t);function e(){var n,r;b5(this,e);for(var i=arguments.length,s=new Array(i),o=0;o<i;o++)s[o]=arguments[o];return r=k5(this,(n=mp(e)).call.apply(n,[this].concat(s))),Ql(Yl(r),"state",{bootstrapped:!1}),Ql(Yl(r),"_unsubscribe",void 0),Ql(Yl(r),"handlePersistorState",function(){var a=r.props.persistor,l=a.getState(),u=l.bootstrapped;u&&(r.props.onBeforeLift?Promise.resolve(r.props.onBeforeLift()).finally(function(){return r.setState({bootstrapped:!0})}):r.setState({bootstrapped:!0}),r._unsubscribe&&r._unsubscribe())}),r}return I5(e,[{key:"componentDidMount",value:function(){this._unsubscribe=this.props.persistor.subscribe(this.handlePersistorState),this.handlePersistorState()}},{key:"componentWillUnmount",value:function(){this._unsubscribe&&this._unsubscribe()}},{key:"render",value:function(){return typeof this.props.children=="function"?this.props.children(this.state.bootstrapped):this.state.bootstrapped?this.props.children:this.props.loading}}]),e}(T.PureComponent);Ql(GC,"defaultProps",{children:null,loading:null});Nf.createRoot(document.getElementById("root")).render(_.jsx(it.StrictMode,{children:_.jsx(Cb,{basename:"/Learn-Lingo/",children:_.jsx(s6,{store:HC,children:_.jsx(GC,{persistor:T5,children:_.jsx(Bz,{})})})})}))});export default O5();
