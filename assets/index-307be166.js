 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xr(B5,V5,"app");const W5={apiKey:"AIzaSyDkWC69rklVP4x89l4iBxXBRgp9ClD9p40",authDomain:"test-582b2.firebaseapp.com",projectId:"test-582b2",storageBucket:"test-582b2.appspot.com",messagingSenderId:"925130837675",appId:"1:925130837675:web:d3470003dae1803bf931ee",databaseURL:"https://test-582b2-default-rtdb.europe-west1.firebasedatabase.app/"},H5=wE(W5),G5=j5(H5);new Dn;const Jl=vU("teachers/getAllTeachers",async(t,e)=>{const n=R5(G5);try{const r=await O5(ac(n,"/"));if(r.exists()){const i=r.val();return Object.values(i)}}catch(r){console.error(r)}});function K5(){const[t,e]=x.useState(null),n=bC(),r={Blue:"Blue",LightPink:"LightPink",Green:"Green",Orange:"Orange",Pink:"Pink"};return x.useEffect(()=>{n(Jl())},[]),x.useEffect(()=>{e(Object.keys(r)[Math.floor(Math.random()*Object.keys(r).length)])},[]),_.jsx(x4,{children:_.jsx(AI,{children:_.jsxs(Kr,{path:"/",element:_.jsx(ZF,{color:t}),children:[_.jsx(Kr,{index:!0,element:_.jsx(nw,{to:"Home"})}),_.jsx(Kr,{path:"/Home",element:_.jsx(s3,{color:t})}),_.jsx(Kr,{path:"/Teachers",element:_.jsx(g4,{})}),_.jsx(Kr,{path:"/Favorites",element:_.jsx(T4,{redirectTo:"/",component:_.jsx(w4,{})})}),_.jsx(Kr,{path:"*",element:_.jsx(C4,{})})]})})})}const q5={teachers:[],isLoading:!1},Y5=TU({name:"teachers",initialState:q5,extraReducers:t=>{t.addCase(Jl.pending,e=>{e.isLoading=!0}).addCase(Jl.fulfilled,(e,{payload:n})=>{e.isLoading=!1,e.teachers=n}).addCase(Jl.rejected,e=>{e.isLoading=!1})}}),Q5=Y5.reducer,X5=uU({reducer:{teachers:Q5}});Of.createRoot(document.getElementById("root")).render(_.jsx(jI,{basename:"/Learn-Lingo/",children:_.jsx(T3,{store:X5,children:_.jsx(K5,{})})}))});export default J5();
