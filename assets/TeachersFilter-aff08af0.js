import{n,R as m,d as le,e as I,f as ce,j as r,s as z,a as te,r as d,b as M,i as de,M as O,B as pe,k as he,l as xe,m as ue,o as ge,u as f,p as fe,q as me,t as ve,v as be}from"./index-499ab82a.js";const Tr=n.ul`
  margin-top: 32px;
  align-items: center;
  display: flex;
...
`,ir=e=>e.teachers.teachers,Rr=e=>e.teachers.isLoading,or=e=>e.teachers.teachersFavorites,Ar=e=>e.teachers.filterFavoritesTeachers,Er=e=>e.teachers.limit,Ir=e=>e.teachers.teachersFilter,ar=n.form`
  max-width: 600px;
  border-radius: 30px;
  position: fixed;
...
`;function D({arr:e,value:t,set:i,height:o,selectedOption:s}){const[l,p]=d.useState(!1),c=()=>{p(!l)},a=x=>{i(x),p(!1)},h=d.useRef(null);return d.useEffect(()=>{const x=u=>{h.current&&!h.current.contains(u.target)&&p(!1)};return document.addEventListener("click",x),()=>{document.removeEventListener("click",x)}},[h]),r.jsxs(kr,{children:[r.jsxs(Cr,{onClick:c,ref:h,children:[r.jsx(Pr,{children:s||t}),r.jsx(zr,{$active:l?!0:void 0,children:r.jsx("use",{href:z+"#icon-chevron-down"})})]}),l&&r.jsx(Br,{$heigh:o||void 0,children:e.map((x,u)=>r.jsx(Or,{onClick:()=>a(x),children:x},u))})]})}const Lr=f.ul`
  display: flex;
...
`;function Dr({color:e,Level:t,setLevel:i,Teachers:o}){const s=te(),[l,p]=d.useState(""),[c,a]=d.useState(""),h=M(ir),x=["French","English","German","Ukrainian","Polish","Spanish","Italian"],u=["A1 Beginner","A2 Elementary","B1 Intermediate","B2 Upper-Intermediate","C1 Advanced","C2 Proficient"];let T=[10,15,20,25,30,35,40];d.useEffect(()=>{if(l+c+t==="")return;const C=o.filter(v=>{const b=l?v.languages.includes(l):!0,P=c?+v.price_per_hour<=c:!0,B=t?v.levels.includes(t):!0;return P&&b&&B});s(h===o?fe(C):me(C))},[l,t,o,s,c]);const G=()=>{s(h===o?ve():be()),p(""),a(""),i("")};return r.jsxs(Lr,{children:[r.jsxs("li",{children:[r.jsx("span",{children:"Languages"}),r.jsx(D,{arr:x,value:"Choose a language",set:p,selectedOption:l})]}),r.jsxs("li",{children:[r.jsx("span",{children:"Level of knowledge"}),r.jsx(D,{arr:u,value:"Choose a level",set:i,selectedOption:t})]}),r.jsxs("li",{children:[r.jsx("span",{children:"Price"}),r.jsx(D,{arr:T,value:"To $",set:a,height:!0,selectedOption:c})]}),r.jsx(Sr,{color:e,onClick:G,children:"Reset filter"})]})}export{Gr as B,$r as C,Dr as T,Er as a,Rr as b,Ir as c,Tr as d,Yr as e,or as f,Ar as g,Nr as h,_r as n,ir as s};
